...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!date || !time) {
      return res.status(400).json({
        success: false,
        error: 'Missing date or time for appointment.'
      });
    }
    ...
    /**
     * Convert date string and time string to ISO 8601 format
     * Example: "Wed Dec 11 2025" + "10:00 AM" -> "2025-12-11T10:00:00-06:00"
     */
    ...
    // Convert to ISO string for GHL API
